...
public class CompanyModel {
    ...
    public String getPublic_exchange() {
        return public_exchange;
    }

    public void setPublic_exchange(String public_exchange) {
        this.public_exchange = public_exchange;
    }
